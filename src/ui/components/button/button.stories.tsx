...
export const OutlineButtons: Story = {
    render: () => (
        <div className={"flex gap-x-2"}>
            <Button>Default</Button>
            <Button isOutlined={true} variant="neutral">
                Neutral
            </Button>
            ...
            <Button isOutlined={true} variant="accent">
                Accent
            </Button>
            <Button isOutlined={true} variant="ghost">
                Ghost
            </Button>
        </div>
    ),
...
export const OutlineStateButtons: Story = {
    render: () => (
        <div className={"flex gap-x-2"}>
            <Button isOutlined={true} variant="success">
                Success
            </Button>
            <Button isOutlined={true} variant="info">
                Info
            </Button>
            <Button isOutlined={true} variant="warning">
                Warning
            </Button>
            <Button isOutlined={true} variant="error">
                Error
            </Button>
        </div>
    ),
